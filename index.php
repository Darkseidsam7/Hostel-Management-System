...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["btnLogin"])) {
        ...
        if ($msg == "true") {
            ...
            //var_dump($result);
            $info = array();
            while ($row = mysqlii_fetch_assoc($result)) {
            ...
            if($info[1]=="UG004")
            {
                header('Location: http://localhost/php/HostelManagementSystem/sdashboard.php');
            }
            elseif($info[1]=="UG003")
            {

                header('Location: http://localhost/php/HostelManagementSystem/edashboard.php');
            }
            else
            {
                header('Location: http://localhost/php/HostelManagementSystem/dashboard.php');
            }
